...
package mz.uem.dmi.dmtp.classifier;
...
/**
 * Class Responsável pela aplicação do modelo gerado pelo weka (atreveis do sous do algoritmo knn) em instances de testes.
 *
...
public class KNNClassifier {
    ...
    public static double predictInstance(final String modelFilename, Instance instance, final String attributeName) throws Exception {
        if (classifier == null)
            classifier = (IBk) weka.core.SerializationHelper.read(modelFilename);
        return classifier.classifyInstance(instance);
    }
